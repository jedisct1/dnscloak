...
PKGPATH=$GOPATH/src/github.com/DNSCrypt/dnscrypt-proxy
...
go get 'github.com/DNSCrypt/dnscrypt-proxy/dnscrypt-proxy/ios'

# make the binary
gomobile bind -target ios $GOMOBILE_FLAGS 'github.com/DNSCrypt/dnscrypt-proxy/dnscrypt-proxy/ios'
